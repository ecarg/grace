...
def get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--clean', help='clean all existing checkpoints', action='store_true', default=False)
    
    #================ Path ==============#
    parser.add_argument('-r', '--rsc-dir', help='resource directory', metavar='DIR', default=RSC_DIR)
    parser.add_argument('-d', '--data-dir', help='data directory', metavar='DIR', default=DATA_DIR)
    parser.add_argument('-p', '--in-pfx', help='input data prefix', metavar='NAME', type=str, default='v2')
    parser.add_argument('--log-dir', help='tensorboard log dir <default: ./logdir>',
                        metavar='DIR', default=LOG_DIR)
    
    #================ Data ==============#
    parser.add_argument('--cutoff', help='cutoff', action='store', type=int, metavar='NUM', default=5)
    parser.add_argument('--n_tags', help='number of NER tags', type=int, metavar='NUM', default=11)
    
    #================ Train ==============#
    parser.add_argument('--learning_rate', type=float, default=1e-4)
    parser.add_argument('--optimizer', type=str, default='Adam')
    parser.add_argument('--batch-size', help='batch size <default: 100>', metavar='INT',
                        type=int, default=100)


    parser.add_argument('--rvt-epoch', help='최대치 파라미터로 되돌아갈 epoch 횟수 <default: 2>',
                        type=int, metavar='NUM', default=2)
    parser.add_argument('--rvt-term', help='파라미터로 되돌아갈 최대 횟수 <default: 10>',
                        type=int, metavar='NUM', default=10)
    
    #================ Model ==============#
    parser.add_argument('-m', '--model-name', help='model name', metavar='NAME', default='Cnn8')
    parser.add_argument('--rnn', type=str, default='gru')
    
    parser.add_argument('--jaso_dim', type=int, metavar='INT', default=50)
    parser.add_argument('--char_dim', type=int, metavar='INT', default=50)
    parser.add_argument('--word_dim', type=int, metavar='INT', default=50)
    
    parser.add_argument('--hidden_dim', type=int, default=1024)
    parser.add_argument('--num_layers', help='number of rnn layers', default=2)

    parser.add_argument('--window', help='left/right character window length <default: 10>',
