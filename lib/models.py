...
=======
    def __init__(self, window, voca, gazet, is_phoneme, gazet_embed):
...
class Fnn3(Ner):
    ...
    """
    def __init__(self, window, voca, gazet, embed_dim, hidden_dim, is_phoneme, gazet_embed):
        """
        :param  window:  left/right window size from current character
        :param  voca:  vocabulary
        ...
        """
        super().__init__(window, voca, gazet, is_phoneme, gazet_embed)
